...
The current image tag in use is: 7b77d99657ab3718ed548ba366ffbcbb15315fd8
...
```shell
  gsed -i s/7b77d99657ab3718ed548ba366ffbcbb15315fd8/some-new-tag/g .github/**/*.yml README.md
```
