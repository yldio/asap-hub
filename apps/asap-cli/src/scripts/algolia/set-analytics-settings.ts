...
export const setAlgoliaAnalyticsSettings = async ({
  ...
  const replicas = [
    ...
    `${indexName}_user_outputs_coproduced_within_asc`,
    `${indexName}_user_outputs_coproduced_within_desc`,
    `${indexName}_user_outputs_coproduced_across_asc`,
    `${indexName}_user_outputs_coproduced_across_desc`,
