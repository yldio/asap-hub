    ...
    expect(window.document.documentElement).toMatchInlineSnapshot(`
      ...
      >
        <head>
          ...
          />
          <link
            href="https://asap.yld.io/.auth/favicon.ico"
            rel="icon"
          />
          <meta
          ...
          />
          <link
            href="https://asap.yld.io/.auth/logo192.png"
            rel="apple-touch-icon"
          />
          <link
            href="https://asap.yld.io/.auth/manifest.json"
            rel="manifest"
          />
          <title>
            ASAP Hub Signin
