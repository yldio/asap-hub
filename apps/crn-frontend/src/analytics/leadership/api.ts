...
export const getAnalyticsOSChampion = async (
  ...
  //             },
  //             {
  //               id: '5af7563f-a34c-43c1-b26d-491226e2e340',
  //               name: 'Devin Another',
  //               awardsCount: 1,
  //             },
  //           ],
  ...
  //       {
  //         _index: 'os-champion-1755238472842',
  //         _id: '2btdr3fgBwkQuzNMVnyaz',
  //         _score: 1,
  //         _source: {
  //           teamId: '2piYltWBLzE5P2n4femVV4',
  //           teamName: 'AA Test Padmini Long Name',
  //           isTeamInactive: true,
  //           teamAwardsCount: 0,
  //           users: [],
  //         },
  ...
  //         _score: 1,
  //         _source: {
  //           teamId: '2piYltWBLzE5P2n4fem3214',
  //           teamName: 'Banteng',
  //           isTeamInactive: false,
  //           teamAwardsCount: 0,
  //           users: [],
  ...
  //         _score: 1,
  //         _source: {
  //           teamId: '463705c4-e70b-470c-918d-b0cdhl4a3415',
  //           teamName: 'Camel',
  //           isTeamInactive: false,
  //           teamAwardsCount: 2,
  //           users: [
