    ...
    await expect(
      getEvents(
        ...
        '',
            ...
            "request to http://localhost:3333/events?take=10&skip=0&after=2021-01-01T11%3A00%3A00.000Z failed, reason: Nock: No match for request {
              \\"method\\": \\"GET\\",
              \\"url\\": \\"http://localhost:3333/events?take=10&skip=0&after=2021-01-01T11%3A00%3A00.000Z\\",
              \\"headers\\": {
                \\"accept\\": \\"*/*\\",
