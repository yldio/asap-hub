...
describe('transformRorInstitutionsToNames', () => {
  ...
  it('returns empty array when response is undefined', () => {
    expect(transformRorInstitutionsToNames(undefined as any)).toEqual([]);
  });
  ...
  it('returns empty array when items is not an array', () => {
    ...
    expect(transformRorInstitutionsToNames(response as any)).toEqual([]);
  });
  ...
  it('handles complex names array with multiple types', () => {
    ...
    expect(transformRorInstitutionsToNames(response)).toEqual(['Official Name']);
  });
});
...
describe('loadInstitutionOptions', () => {
  ...
  it('loads and transforms institutions successfully', async () => {
    ...
    mockGetInstitutions.mockResolvedValue(mockResponse as any);
  ...
  it('handles empty search query', async () => {
    ...
    expect(mockGetInstitutions).toHaveBeenCalledWith({ searchQuery: undefined });
  });

  it('returns empty array when API returns empty items', async () => {
    mockGetInstitutions.mockResolvedValue({ items: [] } as any);
  ...
  it('returns empty array when API returns no items property', async () => {
    mockGetInstitutions.mockResolvedValue({} as any);
