...
const Projects: FC<Record<string, never>> = () => {
  ...
  return (
    <Routes>
      ...
      {/* Project List Routes */}
      <Route path={projects({}).discoveryProjects.template} element={
        <DiscoveryProjects
      ...
      <Route path={projects({}).resourceProjects.template} element={
        <ResourceProjects
          searchQuery={searchQuery}
          onChangeSearchQuery={setSearchQuery}
          filters={filters}
      ...
      <Route path={projects({}).traineeProjects.template} element={
        <TraineeProjects
          searchQuery={searchQuery}
          onChangeSearchQuery={setSearchQuery}
          filters={filters}
