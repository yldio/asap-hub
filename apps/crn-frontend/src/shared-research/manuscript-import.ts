...
export const decideManuscriptImport = (
  ...
  // the version is already linked to a research output
  // that means Preprint already exists
  // and we are just adding a version
  ...
  // lifecycle is Publication and it doesn't have
  // a linked research output, so the backend
  // creates Preprint automatically and the flow
  // becomes add-version
