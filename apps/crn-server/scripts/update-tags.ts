...
- create all the tag data (check if exist first, should be idempotent)
- for each of these tags, query users that have the legacy data, and add the new tag to the tag field
- remove the legacy tag field
*/
