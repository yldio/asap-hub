...
export class UserContentfulDataProvider implements UserDataProvider {
  ...
  async update(
    ...
    const isAlumni = user.fields.alumniSinceDate?.['en-US'] != null;
...
// Shape of the awardsCollection selection on a team membership. Typed locally
// because the autogenerated Contentful types expose it via codegen; this keeps
// the parser resilient to the field being read off the membership.
