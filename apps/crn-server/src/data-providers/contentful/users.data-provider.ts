...
export const parseContentfulGraphQlUsers = (item: UserItem): UserDataObject => {
  ...
  return {
    ...
    orcid: item.orcid ?? '',
    orcidLastModifiedDate: item.orcidLastModifiedDate ?? '',
    orcidLastSyncDate: item.orcidLastSyncDate ?? '',
    alumniLocation: item.alumniLocation ?? '',
    alumniSinceDate: item.alumniSinceDate ?? '',
    reachOut: item.reachOut ?? '',
    researchInterests: item.researchInterests ?? '',
    responsibilities: item.responsibilities ?? '',
    expertiseAndResourceDescription: item.expertiseAndResourceDescription ?? '',
