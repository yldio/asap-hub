...
import {
  ...
  getSquidexGraphqlEventSpeakers,
...
describe('events entity', () => {
  ...
  test('parse the squidex graphql speakers into the response', () => {
    expect(parseGraphQLSpeakers(getSquidexGraphqlEventSpeakers())).toEqual(
      getEventSpeakers(),
    );
  });
