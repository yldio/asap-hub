  ...
  render(
    ...
    >
      <Suspense fallback="loading">
        <Auth0Provider user={{}}>
          <WhenReady>
            <MemoryRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }} initialEntries={[gp2Routing.projects({}).$]}>
              <Routes>
                <Route
...
it('handles filter switching', async () => {
  ...
  await renderProjectsList();
  await userEvent.click(screen.getByLabelText('Opportunities Available'));
