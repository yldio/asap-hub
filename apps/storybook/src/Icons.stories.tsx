...
export const InfoCircleYellow = () => components.infoCircleYellowIcon;
...
export const NumericalSortingIcon = () => <components.NumericalSortingIcon />;
...
export const WorkingGroups = () => <components.WorkingGroupsIcon />;
