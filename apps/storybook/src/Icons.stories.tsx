...
export const NewsEventPlaceholder = () => components.newsEventPlaceholder;
export const EventPlaceholder = () => components.eventPlaceholder;
...
export const GoogleCalendarIcon = () => components.googleCalendarIcon;
