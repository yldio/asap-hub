...
module.exports.up = (migration) => {
  const externalAuthors = migration.createContentType('externalAuthors')
    .name('External Authors')
    .displayField('id')
    .description('')

  externalAuthors.createField('id')
    .name('ID')
    .type('Symbol')

  externalAuthors.createField('separatorBasicData')
    .name('Basic Data')
    .type('RichText')
  ...
  externalAuthors.createField('firstName')
    .name('First Name')
    .type('Symbol')

  externalAuthors.createField('lastName')
    .name('Last Name')
    .type('Symbol')

  externalAuthors.createField('email')
    .name('Email')
    .type('Symbol')

  externalAuthors.createField('orcid')
    .name('ORCID')
    .type('Symbol')

  externalAuthors.createField('teams')
    .name('Teams')
    .type('Array')
    .items({ type: 'Link', validations: [{ linkContentType: ['teams'] }], linkType: 'Entry' })

  externalAuthors.createField('labs')
    .name('Labs')
    .type('Array')
    .items({ type: 'Link', validations: [{ linkContentType: ['labs'] }], linkType: 'Entry' })

  externalAuthors.changeFieldControl('id', 'builtin', 'singleLine')
  externalAuthors.changeFieldControl('separatorBasicData', 'builtin', 'richTextEditor')
...
module.exports.down = migration => migration.deleteContentType('externalAuthors')
