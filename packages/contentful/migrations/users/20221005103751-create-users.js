...
module.exports.up = (migration) => {
  const users = migration.createContentType('users')
    .name('Users')
    .displayField('id')
    .description('')

  users.createField('id')
    .name('ID')
    .type('Symbol')

  users.createField('separatorBasicData')
    .name('Basic Data')
    .type('RichText')
  ...
  users.createField('firstName')
    .name('First Name')
    .type('Symbol')

  users.createField('lastName')
    .name('Last Name')
    .type('Symbol')

  users.createField('email')
    .name('Email')
    .type('Symbol')

  users.createField('type')
    .name('Some type')
    .type('Symbol')

  users.createField('orcid')
    .name('ORCID')
    .type('Symbol')

  users.createField('teams')
    .name('Teams')
    .type('Array')
