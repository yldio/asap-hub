...
CONTENTFUL_SPACE_ID=$CONTENTFUL_SPACE_ID CONTENTFUL_ENV_ID=$CONTENTFUL_ENV_ID CONTENTFUL_MANAGEMENT_ACCESS_TOKEN=$CONTENTFUL_MANAGEMENT_ACCESS_TOKEN CONTENTFUL_MIGRATIONS_DIR=$CONTENTFUL_MIGRATIONS_DIR yarn workspace @asap-hub/contentful space:migrate:dryrun
