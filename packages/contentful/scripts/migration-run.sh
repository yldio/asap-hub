...
CONTENTFUL_SPACE_ID=$CONTENTFUL_SPACE_ID CONTENTFUL_ENV_ID=Mark CONTENTFUL_MANGEMENT_ACCESS_TOKEN=$CONTENTFUL_MANGEMENT_ACCESS_TOKEN CONTENTFUL_MIGRATIONS_DIR=migrations/$APP_NAME yarn workspace @asap-hub/contentful space:migrate
