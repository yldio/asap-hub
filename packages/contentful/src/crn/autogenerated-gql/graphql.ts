...
/** ASAP Hub News [See type definition](https://app.contentful.com/spaces/5v6w5j61tndm/content_types/news) */
export type NewsExternalLinkArgs = {
  locale: InputMaybe<Scalars['String']>;
};


/** ASAP Hub News [See type definition](https://app.contentful.com/spaces/5v6w5j61tndm/content_types/news) */
export type NewsExternalLinkTextArgs = {
  locale: InputMaybe<Scalars['String']>;
};
...
export type NewsFilter = {
  ...
  externalLinkText_contains: InputMaybe<Scalars['String']>;
  externalLinkText_exists: InputMaybe<Scalars['Boolean']>;
  externalLinkText_in: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  externalLinkText_not: InputMaybe<Scalars['String']>;
  externalLinkText_not_contains: InputMaybe<Scalars['String']>;
  externalLinkText_not_in: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
...
export enum NewsOrder {
  ExternalLinkTextAsc = 'externalLinkText_ASC',
  ExternalLinkTextDesc = 'externalLinkText_DESC',
