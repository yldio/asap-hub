...
export type FetchOutputsByRelatedOutputIdQueryVariables = Exact<{
  id: Scalars['String'];
  limit?: InputMaybe<Scalars['Int']>;
  skip?: InputMaybe<Scalars['Int']>;
  preview?: InputMaybe<Scalars['Boolean']>;
...
export type FetchOutputsByRelatedOutputIdQuery = {
  outputs?: Maybe<{
    sys: Pick<Sys, 'id'>;
    linkedFrom?: Maybe<{
      outputsCollection?: Maybe<
...
>;
export const FetchOutputsByRelatedOutputIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'FetchOutputsByRelatedOutputId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
  ...
  FetchOutputsByRelatedOutputIdQuery,
  FetchOutputsByRelatedOutputIdQueryVariables
>;
