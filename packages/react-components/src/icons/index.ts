...
export { default as crnLogo } from './crn-logo-mobile';
...
export { default as DiscoveryProjectIcon } from './discovery-project';
export { default as DiscoveryTeamIcon } from './discovery-team';
...
export { default as GeneralSortingIcon } from './general-sorting';
...
export { default as neutralFaceIcon } from './neutral-face';
...
export { default as plusRectIcon } from './plus-rect';
...
export { default as sadFaceIcon } from './sad-face';
...
export { default as TraineeProjectIcon } from './trainee-project';
