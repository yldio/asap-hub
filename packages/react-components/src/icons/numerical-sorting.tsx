...
const NumericalSortingIcon: React.FC<NumericalSortingIconProps> = ({
  ...
  const title = active
    ? ascending
      ? 'Active Numerical Ascending Sort Icon'
      : 'Active Numerical Descending Sort Icon'
    : ascending
      ? 'Inactive Numerical Ascending Sort Icon'
      : 'Inactive Numerical Descending Sort Icon';
