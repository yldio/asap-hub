...
describe('ManuscriptForm team validation', () => {
  ...
  it.each`
    authorType                | label                     | errorMessage
    ${'first author'}         | ${/First Author/}         | ${/The following first author\(s\) are not members of this project/i}
    ${'corresponding author'} | ${/Corresponding Author/} | ${/The following corresponding author\(s\) are not members of this project/i}
    ${'additional author'}    | ${/Additional Author/}    | ${/The following additional author\(s\) are not members of this project/i}
  `(
