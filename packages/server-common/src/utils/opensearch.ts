...
/**
 * Deletes documents by matching on the `id` field in the document body.
 * This works regardless of the `_id` strategy used at index time
 * (auto-generated by full reindex or explicit `_id: doc.id` by event sync).
 */
export const deleteByDocumentIds = async (
  client: Client,
  indexAlias: string,
  ids: string[],
): Promise<void> => {
